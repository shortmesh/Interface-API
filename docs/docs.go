...
const docTemplate = `{
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/adminsession.LoginResponse"
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/adminsession.SetMatrixTokenRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/adminsession.SetMatrixTokenResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/adminsession.MatrixTokenStatusResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "401": {
                        "description": "Unauthorized",
                        "schema": {
                            "$ref": "#/definitions/webhooks.ErrorResponse"
                        }
                    },
                    "500": {
                        "description": "Internal server error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/webhooks.AddWebhookRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/webhooks.MessageResponse"
                        }
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "adminsession.MatrixTokenStatusResponse": {
            "type": "object",
            "properties": {
                "has_matrix_token": {
                    "type": "boolean",
        ...
        "adminsession.SetMatrixTokenRequest": {
            "type": "object",
            "properties": {
                "token": {
                    "type": "string",
        ...
        "adminsession.SetMatrixTokenResponse": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string",
                    "example": "Matrix token attached to session"
                },
                "status": {
                    "type": "string",
                    "example": "ok"
